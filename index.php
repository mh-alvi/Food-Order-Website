<?php include('partials-frontend/menu.php'); ?>
    ...
    <section class="categories">
        <div class="container">
            ...
            <?php
                //Create sql query to display database
                ...
                if($count>0){
                    ...
                    while($row=mysqli_fetch_assoc($res)){
                        //Get the value like id, name, image
                        $id = $row['id'];
                        $title = $row['title'];
                                ...
                                <div class="box-3 float-container">
                                    <?php 
                                        ...
                                        if($image_name == ""){
                                            ...
                                            //image available
                                            ?>
                                                <img src="<?php echo SITEURL; ?>images/category-image/<?php echo $image_name; ?>" alt="Pizza" class="img-responsive img-curve">
                                            <?php
                                        }
                                    ?>
