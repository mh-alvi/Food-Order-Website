                    ...
                    <td>
                        <?php
                            if($current_image == ""){
                                ...
                                //image available
                                ?>
                                    <img src="<?php echo SITEURL; ?>images/food-image/<?php echo $current_image; ?>" width="100px">
                                <?php
                            }
                        ?>
                    </td>
            ...
            if(isset($_POST['submit'])){
                ...
                if(isset($_FILES['image']['name'])){
                    ...
                    if($image_name != ""){
                        ...
                        //rename the image
                        $image_name = "Food_Name_" .rand(0000, 9999). '.' .$ext; //e.g. Food_category_203.jpg format
                        ...
                        if($upload == false){
                            ...
                            // redirecting page to add category
                            header("location:" . SITEURL . 'backend/manage-food.php');
                            //stop the process
                            die();
                        }
                    //3. Remove the image if new image is uploaded and current image exist
                        ...
                        if($current_image != ""){
                            ...
                            $remove_path = "../images/food-image/".$current_image;
                ...
                if($res3 == true){
                    ...
                    header("loaction:" .SITEURL. 'backend/manage-food.php');
                }
                //4. Update the food in database
                //5. Redirect to manage food with message
            }
